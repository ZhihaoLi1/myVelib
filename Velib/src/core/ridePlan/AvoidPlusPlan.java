...
/**
 * the source, respectively the destination, station, for a ride should as close as possible
 * to the starting, respectively to the destination, location of the ride.
 * <br>
